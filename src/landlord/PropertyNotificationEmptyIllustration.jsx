import "./PropertyNotificationEmptyIllustration.css";
export const PropertyNotificationEmptyIllustration = () => (<svg aria-hidden="true" viewBox="0 0 180 145" className="property-notification-empty-illustration-svg-icon" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
