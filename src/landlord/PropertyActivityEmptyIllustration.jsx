import "./PropertyActivityEmptyIllustration.css";
export const PropertyActivityEmptyIllustration = () => (<svg aria-hidden="true" viewBox="0 0 180 145" className="property-activity-empty-illustration-svg-icon" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
